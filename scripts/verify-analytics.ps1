...
$events = @('phone_click','phone_prompt_open','phone_dial','goo_net_click','cta_click','article_card_click','recruit_link_click','indeed_apply_click','recruit_form_submit_start','recruit_form_submit_success','recruit_form_submit_error','scroll_depth','recruit_entry_view','sales_section_view','column_section_view','used_car_stock_view')
